...
% One swimmer is fixed at (0,0,0) facing right.
% Set the coordinates of the other here:
x0 = -2;
y0 = 0; % Preset 1 (default).
% y0 = +0.1; % Preset 2 
% y0 = -0.1; % Preset 3
theta0 = pi;
...
[PosS] = seed_ArtifSeedSwimmers(Ns, Xsi, Ysi, RS, SBT, SDV, x0, y0, theta0);
...
[PosC] = seed_ArtifSeedColloids(Nc, Xsi, Ysi, RC, 0, 0);
PosSold = zeros(Ns,5);
PosCold = zeros(Nc,4);
PosStemp = zeros(Ns,5);
PosCtemp = zeros(Nc,3);
