...
% Set bounds on the inputs
wTorq0 = -0.5;
wTorqF = -0.5;

for wTorq = wTroq0:wTorq0:wTorqF
    
    seedNum = wTorq*(1/wTorq0);
    ...
    for n = 1:Nstep-1 % loop over steps.
        ...
        PosSnew1(:,:) = moveSwimmer1(PosSold,DuDiS,Ns,FS,dt,DSr,FTSi,VS,SWT,Ysi,Xsi,k,RS,MoMax,kickType,SDV,SBT,polarity,kickMethod,wTorq,stream);
        ...
        % Implement the swimmer and colloid move factoring for BC.
        % Note: generic moveswimmer? could be used here for both 1 and 2.
        PosSnew2(:,:) = moveSwimmer2(PosSnew1,DuDiS,Ns,FS,dt,DSr,FTSi,VS,SWT,Ysi,Xsi,k,RS,MoMax,kickType,SDV,SBT,polarity,kickMethod,wTorq,stream);
